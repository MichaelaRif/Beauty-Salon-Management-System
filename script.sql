...
CREATE TABLE public.customers (
    ...
    customer_passhash character varying(255) NOT NULL,
    customer_dob date NOT NULL,
    customer_pronouns character varying(255) NOT NULL,
...
CREATE TABLE public.employees (
    ...
    employee_passhash character varying(255) NOT NULL,
    employee_dob date NOT NULL,
    employee_pronouns character varying(255) NOT NULL,
